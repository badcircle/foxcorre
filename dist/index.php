  ...
  <body>
    ...
    <div class="container">
        <div class="columns">
            <div class="column has-text-white">
                <h1 data-aos="zoom-out-right" class="is-size-1-tablet is-size-4-touch is-size-2-desktop mt-6 has-text-left wrapped"><span class="px-6" style="background-color: #8a4d76;">join our <span class="display-font ml-3">buyer's list</span></span></h1>
            </div>
        </div>
        <div class="columns is-centered is-mobile pt-6">
            <div class="column is-7-desktop is-10-mobile is-10-tablet">
                <div class="box p-6" data-aos="zoom-in" data-aos-delay="200" data-aos-duration="700">
                    <div class="block">
                        <div class="columns is-vcentered is-mobile">
                            ...
                            <div class="column is-size-7-touch">
                                Join today to start receiving accurate, up-to-date market analyses and investment opportunities. Change your delivery frequency, pause or unsubscribe anytime.
                            </div>
                        </div>
                    </div>
                    <div class="block">
                        ...
                        <div class="columns is-mobile">
                            ...
                            <div class="column" style="align-self: flex-end; margin-bottom: 10px;">
                                <div class="field has-text-right">
                                    <input id="smsCheckbox" type="checkbox" name="sms" class="checkbox" checked="checked"> 
                    ...
                    <div class="block">
                        <p class="is-size-7">We market real estate and investment opportunities, not user data. Your information is used only for its stated purpose. We do not sale or share your information without outside parties. Read our <a href="javascript:void(0)">privacy policy</a> for more information.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="columns is-centered">
            <div class="column">
                <h2 class="is-size-2-desktop is-size-4-mobile is-size-3-tablet has-text-centered p-6"><span class="display-font mr-3 underline-border" style="font-size: 125%;">real solutions</span> <br class="rwd-break">for real estate investors</h2>
            </div>
        </div>
    </div>
    </div>
    ...
    <div class="container is-fluid has-background-grey-dark is-relative px-0" style="z-index: 0;" id="stepswrapper">
        <div class="container is-fluid px-0 pb-6">
            ...
            <div class="container has-text-white p-6">
                <h1 class="is-size-2 has-text-centered" style="padding-top: 120px; line-height: 1;">solutions made sample</h1>
                <div class="block has-text-centered my-6">
                    <p>
                        The FoxCorRE process is streamlined for finding a property, securing funding, unlocking its value, and selling or leasing that home as soon as possible.
                    </p>
                </div>
            ...
            <div class="columns p-6 is-gapless" style="margin-bottom: 150px;">
                <div class="column">
                    ...
                    <div class="block">
                        ...
                        <p class="subtitle is-size-6">When it is time to sell or lease your property, we have self-service as well as full-service brokerage options.</p>
                    </div>
                    <div class="block">
                        <div class="title is-size-5">Mentorship</div>
                        <p class="subtitle is-size-6">We guide you with a simplified solution for your real estate investment outcomes.</p>
                    </div>
                    </div>
                </div>
                <div class="column">
                    ...
                    <div class="block">
                        ...
                        <p class="subtitle is-size-6">Our Brokerage delivers properties both on and off the Multiple Listing Service. This gives you a 360-degree approach to finding the perfect investment property. Our properties are up to 50% off market value and delivered straight to your inbox.</p>
                    </div>
                    <div class="block">
                        <div class="title is-size-5">Integrity</div>
                        <p class="subtitle is-size-6">Our interest is looking out for your best interest. With impeccable morals down to our core, we will provide you with a flawless experience.</p>
                    </div>
                    </div>
                </div>
            </div>
